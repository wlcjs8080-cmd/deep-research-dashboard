...
- 마지막 작업일: 2026-02-25
- app.py 버전: 12개 항목 체계, FMP 어닝콜 함수 포함
- LLM 모델: GPT-4.1 (Opus 4.6 전환 대기 중)
- 배포 상태: Streamlit Cloud 정상 운영 중
- 분석 품질: 4/10점 (목표 7점 이상)
- Supabase: 미연결
- .cursor/rules: 신규 도입 완료
...
## Phase 1 — 즉시 수정 (UI/코드)
- [ ] 1-1. 취소선(~~) 완전 차단 (raw LLM 응답 전체에서 제거)
